...
const Home = () => {
  return (
    <div className="h-screen overflow-y-scroll scroll-smooth snap-y snap-mandatory bg-black text-white">
      ...
      <section
        id="intro"
        className="snap-start relative z-10 flex flex-col justify-center items-center text-center px-4 pt-48 md:pt-64 pb-32 bg-black"
      >
        <motion.h1
      ...
      <section
        id="services"
        className="snap-start py-20 px-4 md:px-20 bg-gray-900"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="bg-gray-800 p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-300">
              Commercials, documentaries, events – crafted with cinematic quality.
            </p>
          </div>
          <div className="bg-gray-800 p-6 rounded-xl shadow-md">
            <h3 className="text-xl font-semibold mb-4">Photography</h3>
            <p className="text-gray-300">
              Weddings, corporate shoots, lifestyle & editorial visual storytelling.
            </p>
          </div>
          <div className="bg-gray-800 p-6 rounded-xl shadow-md">
            <h3 className="text-xl font-semibold mb-4">Drone & 3D</h3>
            <p className="text-gray-300">
              Aerial drone work and 3D scenes to elevate your visual experience.
            </p>
          </div>
        </div>
      </section>
