...
import Hero from '../components/Hero'; // This includes the 3D scene
...
const Home = () => {
  return (
    <div className="bg-black text-white">
      ...
      {/* Intro Section (Overlay style still preserved) */}
      ...
      {/* Services Teaser */}
      <section className="py-20 px-4 md:px-20 bg-gray-900">
